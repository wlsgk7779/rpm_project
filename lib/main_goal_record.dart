...
class GoalRecordPage extends StatefulWidget {
  const GoalRecordPage({super.key});

  @override
  State<GoalRecordPage> createState() => _GoalRecordPageState();
}

class _GoalRecordPageState extends State<GoalRecordPage> {
  List<String> records = [
    "2025.03.25 | 1km | 10분",
    "2025.03.30 | 5km | 40분",
    "2025.04.05 | 2km | 15분",
